...
<div class="row">
    <div class="col">
        <!-- PAGE CONTENT BEGINS -->
        <form method="post" class="form-horizontal" action="<?= base_url() . 'fnp/masterdata/editbs/' . $databs['idbs']; ?>" enctype="form-data/multipart" data-parsley-validate="true">
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Bentuk Sediaan </label>

                <div class="col-sm-9">
                    <input type="text" name="bentuksediaan" id="bentuksediaan" placeholder="Bentuk Sediaan" class="col-xs-10 col-sm-5" value="<?= $databs['bentuksediaan']; ?>" required/>
                </div>
            </div>
